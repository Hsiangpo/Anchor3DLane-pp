_base_ = './anchor3dlane++_r50x2_lpf_t.py'
...
lane_loss_lof_oc = dict(
    ...
    loss_weights=dict(cls_loss=1,
                      ...
                      ownership_contrast_losses=0.02,
                      ownership_mil_losses=0.015),
    assign_cfg=dict(
        cost_class=3.0,
        cost_dist=1.0,
    ),
...
load_from = 'output/openlane/experiments/lpf_t_r50x2/iter_10000.pth'
work_dir = 'output/openlane/experiments/lof_oc_r50x2'
